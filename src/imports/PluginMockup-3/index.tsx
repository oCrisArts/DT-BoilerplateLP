import svgPaths from "./svg-0pxh4b45i3";
...
function Button() {
  return (
    <div className="flex-[1_0_0] min-w-px relative" data-name="Button">
      ...
      <div className="[word-break:break-word] bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col font-medium items-center justify-center leading-[15px] pb-[10px] pt-[8px] relative size-full text-[#6e6e80] text-[10px] text-center whitespace-nowrap">
        <p className="font-['Material_Symbols_Outlined:Medium',sans-serif] relative shrink-0" style={{ fontVariationSettings: '"FILL" 0, "GRAD" 0' }}>{`palette `}</p>
        <p className="font-['DM_Sans:Medium',sans-serif] relative shrink-0" style={{ fontVariationSettings: '"opsz" 14' }}>
          Colors
        </p>
      </div>
    </div>
...
function Button1() {
  return (
    <div className="flex-[1_0_0] min-w-px relative" data-name="Button">
      ...
      <div className="[word-break:break-word] bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-center justify-center pb-[10px] pt-[8px] relative size-full text-center whitespace-nowrap">
        <p className="font-['Material_Symbols_Outlined:Regular',sans-serif] font-normal leading-[14px] relative shrink-0 text-[#6e6e80] text-[14px]" style={{ fontVariationSettings: '"FILL" 0, "GRAD" 0' }}>
          font_download
        </p>
        <p className="font-['DM_Sans:Medium',sans-serif] font-medium leading-[15px] relative shrink-0 text-[#5e6ad2] text-[10px]" style={{ fontVariationSettings: '"opsz" 14' }}>
          Typography
        </p>
      </div>
    </div>
...
function Button3() {
  return (
    <div className="h-[48px] relative shrink-0 w-full" data-name="Button">
      <div aria-hidden className="absolute border-[rgba(0,0,0,0)] border-b-2 border-solid inset-0 pointer-events-none" />
      <div className="[word-break:break-word] bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[8px] items-center justify-center pb-[10px] pt-[8px] relative size-full text-[#5e6ad2] text-[10px] text-center whitespace-nowrap">
        <p className="font-['Material_Symbols_Outlined:Medium',sans-serif] font-medium leading-[0] relative shrink-0" style={{ fontVariationSettings: '"FILL" 0, "GRAD" 0' }}>
          <span className="leading-[15px]" style={{ fontVariationSettings: '"FILL" 0, "GRAD" 0' }}>
            font_download
          </span>
          <span className="leading-[15px]">{`️ `}</span>
        </p>
        <p className="font-['DM_Sans:Medium',sans-serif] font-medium leading-[15px] relative shrink-0" style={{ fontVariationSettings: '"opsz" 14' }}>
          Family
        </p>
        <p className="font-['Material_Symbols_Outlined:Regular',sans-serif] font-normal leading-[15px] relative shrink-0" style={{ fontVariationSettings: '"FILL" 0, "GRAD" 0' }}>
          expand_less
        </p>
      </div>
    </div>
  ...
  return (
    <div className="relative rounded-[4px] shrink-0 size-[24px]" data-name="Container">
      ...
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-center justify-center p-[10px] relative size-full">
        <p className="[word-break:break-word] font-['Material_Symbols_Outlined:Regular',sans-serif] font-normal leading-[15px] relative shrink-0 text-[#0c0c0d] text-[10px] whitespace-nowrap" style={{ fontVariationSettings: '"FILL" 0, "GRAD" 0' }}>
          format_shapes
        </p>
      </div>
    </div>
  ...
  return (
    <div className="flex-[1_0_0] min-w-px relative" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-start overflow-clip relative rounded-[inherit] size-full">
        <p className="[word-break:break-word] font-['Consolas:Regular',sans-serif] leading-[15px] not-italic relative shrink-0 text-[#0c0c0d] text-[10px] whitespace-nowrap">font-family-sans</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="flex-[172.359_0_0] min-w-px relative" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center overflow-clip relative rounded-[inherit] size-full">
        <p className="[word-break:break-word] font-['Consolas:Regular',sans-serif] leading-[15px] not-italic relative shrink-0 text-[#0c0c0d] text-[10px] whitespace-nowrap">font-family-icon</p>
      </div>
    </div>
  );
}
...
function Text4() {
  return (
    <div className="flex-[172.359_0_0] min-w-px relative" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center overflow-clip relative rounded-[inherit] size-full">
        <p className="[word-break:break-word] font-['Consolas:Regular',sans-serif] leading-[15px] not-italic relative shrink-0 text-[#0c0c0d] text-[10px] whitespace-nowrap">font-family-cursor</p>
      </div>
    </div>
  );
}
...
function Button4() {
  return (
    <div className="h-[48px] relative shrink-0 w-full" data-name="Button">
      <div aria-hidden className="absolute border-[rgba(0,0,0,0)] border-b-2 border-solid inset-0 pointer-events-none" />
      <div className="[word-break:break-word] bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[8px] items-center justify-center pb-[10px] pt-[8px] relative size-full text-[#6e6e80] text-center whitespace-nowrap">
        <p className="font-['Material_Symbols_Outlined:Regular',sans-serif] font-normal leading-[13px] relative shrink-0 text-[13px]" style={{ fontVariationSettings: '"FILL" 0, "GRAD" 0' }}>
          format_size
        </p>
        <p className="font-['DM_Sans:Medium',sans-serif] font-medium leading-[15px] relative shrink-0 text-[10px]" style={{ fontVariationSettings: '"opsz" 14' }}>
          Sizes
        </p>
        <p className="font-['Material_Symbols_Outlined:Regular',sans-serif] font-normal leading-[15px] relative shrink-0 text-[10px]" style={{ fontVariationSettings: '"FILL" 0, "GRAD" 0' }}>
          expand_more
        </p>
      </div>
    </div>
