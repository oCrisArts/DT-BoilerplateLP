...
for (const [index,module] of ['colors','typography','layout'].entries()) {
  ...
  const html = `<!doctype html><html><head><link href="https://fonts.googleapis.com/css2?family=DM+Sans:opsz,wght@9..40,400;9..40,500;9..40,700;9..40,900&display=swap" rel="stylesheet"><style>
  *{box-sizing:border-box}body{margin:0;background:transparent;font-family:'DM Sans',Arial,sans-serif;color:#273142;padding:0 20px 40px}
